...
<main class="main-content">
    <div class="p-6 lg:p-8 pt-20 lg:pt-8">
        ...
        <!-- Vehicle Form -->
        <form action="vehicle-add.php" method="POST" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <div class="mb-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <select name="marque" required class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <select name="annee" required class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600">
            ...
            <div class="mb-10">
                ...
                <div class="mb-6">
                    ...
                    <div class="flex flex-col md:flex-row gap-4">
                        <div class="flex-1">
                            <input type="url" name="image_principale" required
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600"
            ...
            <div class="mb-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <select name="type_moteur" required class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="prix_jour" required min="20" max="1000" step="0.01"
