...
if (isset($_POST["modifier"])) {
    ...
    $categorie->update($categoryName, $categoryDescription);
                ...
                <div class="bg-gray-50 rounded-xl p-6 border border-gray-200">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" value="<?= $categorie->__get("nom") ?>"
                                    id="categoryName"
                                    name="categoryName"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input id="categoryDescription" value="<?= $categorie->__get("description") ?>"
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <button type="submit" name="modifier"
                            ...
                            <div class="relative flex items-center justify-center">
                                ...
                                <span class="text-lg">Modifier la catégorie</span>
                            </div>
                        </button>
