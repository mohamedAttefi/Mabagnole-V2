...
<head>
    ...
    <style>
        ...
        .image-zoom {
            transition: transform 0.6s shadow 0.6s;
        }
    ...
    <nav class="glass-nav fixed top-0 w-full z-[100] border-b border-slate-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20 items-center">
                <!-- Logo -->
                <a href="MABAGNOLE-V2/index.php" class="flex items-center gap-2 group">
                ...
                <div class="hidden md:flex items-center space-x-10 text-sm font-semibold uppercase tracking-wider">
                    <!-- Liens communs -->
                    <a href="/MABAGNOLE-V2/public/vehiculeListing.php" class="text-slate-600 hover:text-blue-600 transition">Catalogue</a>
                    <a href="/MABAGNOLE-V2/public/blogs/blog.php" class="text-slate-600 hover:text-blue-600 transition">L'actu</a>
                    ...
                    <?php if (isset($_SESSION['user_id'])): ?>
                        ...
                        <?php if ($_SESSION['user_role'] === 'admin'): ?>
                            <div class="relative group">
                                ...
                                <div class="absolute hidden group-hover:block bg-white shadow-2xl rounded-xl mt-2 py-2 w-48 z-50 border border-slate-100">
                                    <a href="/MABAGNOLE-V2/admin/dashboard.php" class="block px-4 py-2 text-sm hover:bg-slate-50">Tableau de bord</a>
                                    <a href="/MABAGNOLE-V2/admin/Gestion_des_véhicules/vehicles.php" class="block px-4 py-2 text-sm hover:bg-slate-50">Gestion véhicules</a>
                                    <a href="/MABAGNOLE-V2/admin/Gestion_des_réservations/reservations.php" class="block px-4 py-2 text-sm hover:bg-slate-50">Réservations</a>
                                    <a href="/MABAGNOLE-V2/admin/Gestion_des_utilisateurs/users.php" class="block px-4 py-2 text-sm hover:bg-slate-50">Clients</a>
                                    <a href="/MABAGNOLE-V2/admin/Gestion_des_catégories/categories.php" class="block px-4 py-2 text-sm hover:bg-slate-50">Clients</a>
                                    <a href="/MABAGNOLE-V2/admin/Gestion_du_blog/blogs.php" class="block px-4 py-2 text-sm hover:bg-slate-50">Clients</a>
                        ...
                        <?php else: ?>
                            ...
                            <div class="relative group">
                                ...
                                <div class="absolute hidden group-hover:block bg-white shadow-2xl rounded-xl mt-2 py-2 w-48 z-50 border border-slate-100">
                                    <a href="/MABAGNOLE-V2/client/profile.php" class="block px-4 py-2 text-sm hover:bg-slate-50">
                                        <i class="fas fa-user mr-2"></i>Mon profil
                                    </a>
                                    <a href="/MABAGNOLE-V2/client/dashboard.php" class="block px-4 py-2 text-sm hover:bg-slate-50">
                                        <i class="fas fa-user mr-2"></i>Dashboard
                                    </a>
                                    <a href="/MABAGNOLE-V2/client/reservation/my-reservation.php" class="block px-4 py-2 text-sm hover:bg-slate-50">
                                        <i class="fas fa-calendar-alt mr-2"></i>Mes réservations
                                    </a>
                                    <a href="/MABAGNOLE-V2/client/reviews.php" class="block px-4 py-2 text-sm hover:bg-slate-50">
                                        <i class="fas fa-star mr-2"></i>Mes avis
                                    </a>
                                    <a href="/MABAGNOLE-V2/client/favorites.php" class="block px-4 py-2 text-sm hover:bg-slate-50">
                                        <i class="fas fa-heart mr-2"></i>Favoris
                                    </a>

                                    <a href="/MABAGNOLE-V2/client/blogs/my-articles.php" class="block px-4 py-2 text-sm hover:bg-slate-50">
                                        <i class="fas fa-calendar-alt mr-2"></i>My articles
                                    </a>
                                </div>
                            </div>
                        <?php endif; ?>
